...
exports.UserModule = UserModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_entity_1.UserEntity, grade_entity_1.GradeEntity, subjects_entity_1.SubjectsEntity, subjects_entity_1.SubjectsEntity, grade_entity_1.GradeEntity, application_entity_1.ApplicationEntity]),
            jwt_1.JwtModule.register({
                secret: jwtConstants_1.JwtConstants.secret
            })
        ],
        controllers: [user_controller_1.UserController],
        providers: [user_service_1.UserService, encryption_service_1.EncryptionService, grade_service_1.GradeService, subjects_service_1.SubjectsService],
